        ...
        <form onSubmit={handleLogin} className="space-y-8">
          <div>
            ...
            <input
              ...
              className="w-full px-6 py-4 text-xl border-2 border-gray-300 rounded-xl focus:border-purple-500 focus:ring-2 focus:ring-purple-500 outline-none transition-all"
